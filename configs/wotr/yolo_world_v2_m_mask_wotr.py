...
load_from = 'pretrained_models/m_stage2-9987dcb1.pth'
# text_model_name = '../pretrained_models/clip-vit-base-patch32-projection'
text_model_name = 'openai/clip-vit-base-patch32'
persistent_workers = False

wotr_classes = (
    'tree', 'red_light', 'green_light', 'crosswalk', 'blind_road',
    'sign', 'person', 'bicycle', 'bus', 'truck',
...
wotr_train_dataset = dict(
    ...
    dataset=dict(
        ...
        data_root='/home/heat/WOTR_YOLO/',
        ann_file='annotations/instances_train.json',
        data_prefix=dict(img='images/train/'),
        filter_cfg=dict(filter_empty_gt=False, min_size=32),
        metainfo=dict(classes=wotr_classes),
    ),
    class_text_path='/home/heat/WOTR_YOLO/texts/wotr_class_texts.json',
...
train_pipeline = [
    t for t in train_pipeline
    if not (isinstance(t, dict) and t.get('type') == 'mmdet.Albu')
]
train_pipeline_stage2 = [
    t for t in train_pipeline_stage2
    if not (isinstance(t, dict) and t.get('type') == 'mmdet.Albu')
]
...
val_evaluator = dict(
    ...
    ann_file='/home/heat/WOTR_YOLO/annotations/instances_val.json',
    metric='bbox'
)
